...
namespace Country_State_City_Final.Areas.Country.Controllers
{
    ...
    public class CountryController : Controller
    {
        ...
        public IActionResult CountrySave(Countrymodel Model)
        {
            ...
            if (Convert.ToBoolean(cmd.ExecuteNonQuery()) && Model.CountryID != 0)
            {
                TempData["countryaddeditmessage"] = "Country edited succesfullly";
            }
            else
            {
                TempData["countryaddeditmessage"] = "New Country Added succesfullly";
            }
            sqlConnection.Close();
